...
public class ShootPose extends Command {
  ...
  public ShootPose(Drive drivetrain, Shooter shooter, Intake intake) {
  ...
  public void execute() {
    ...
    var speeds = drivetrain.getRobotRelativeSpeeds();
    double speed =
    ...
    if (yawController.atSetpoint()
        ...
        && shooter.isShooterAtSpeed(ShooterConstants.shootingRPS, 0.05)
        && speed < 1.0) {
