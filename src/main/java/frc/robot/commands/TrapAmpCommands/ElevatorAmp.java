...
public class ElevatorAmp extends Command {
  ...
  public ElevatorAmp(Intake intake, Shooter shooter, ElevatorTrap elevatorTrap) {
    this.intake = intake;
  ...
  public void initialize() {
    ...
    elevatorTrap.setElevatorPosition(ElevatorConstants.ampPosition);
    elevatorTrap.setTrapSpeed(TrapConstants.trapAmpScoreSpeed);
